...
int main(int argc, char *argv[]) {
  ...
  if (argc != 3) {
    ...
    fprintf(helpfs, "  -Q          how to solve for probabilities in non-hierarchical scheme: [2]\n");
    fprintf(helpfs, "                0 = matrix inversion, no re-normalization\n");
    fprintf(helpfs, "                1 = voting, no re-normalization\n");
    fprintf(helpfs, "                2 = voting overrides matrix inversion, conditional probabilities\n");
    fprintf(helpfs, "                    are adjusted and re-normalized [default]\n");
