...
having both positive and negative elements in each row 
...
%fuck it, I'm going to submit this to JMLR... should be good for a laugh
%(since I can't get the stupid PR Letters format to compile...)
%I bet they return it after about two days
%I'm calling it here to have a public record...
