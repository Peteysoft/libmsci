...
It will be tested a kernel-based classifier called a support vector
...
LIBLINEAR is very fast for both training and prediction.
...
LIBSVM is not very fast but tends to be very accurate.
