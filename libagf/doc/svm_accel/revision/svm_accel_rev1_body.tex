...
(\ref{class_value}).
The time complexity is independent of the number
...
{\correction Then the number of border vectors should be proportional to the volume
...
\footnote{This relation has been corrected from its published version.}
\begin{eqnnon}
	\minborders \propto \mintrain^\frac{\dimension-1}{\dimension}
	\label{scaling_law}
\end{eqnnon}
}
...
{\correction although the advantage becomes less the larger the dimension of the 
feature space.}
