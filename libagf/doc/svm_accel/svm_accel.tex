...
test values for which the first classifier (the ``truth'') takes on the value $i$
while the second classifier (the estimate) takes on the value $j$.
...
\bibliography{../agf_bib,svm_accel}
