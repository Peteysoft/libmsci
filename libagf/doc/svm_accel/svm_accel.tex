...
If the class domains are simply connected and don't wrap around, 
...
The collection of
covers a fairly broad range of size and types of problems, 
...
borders method decreases the accuracy of this simpler kernel estimator.
...
\begin{table}
	\caption{Confusion matrices for splice dataset}
	\label{confusion}
	\input{confusion.tex}
\end{table}
...
and SVM-borders classifiers as shown in Table \ref{confusion}.
Just by inspection one can see that SVM is much better calibrated than
SVM-borders.
