...
Interestingly, the heart dataset classifiers so fast that it was not detected
...
of the two methods and lists all the relevant variables: number of variables,
...
classification time for the two methods. The two most relevant variables are the
...
data in real time.
This is especially true considering the high performance ratios for some of the problems: the
humidity dataset is sped up by almost 20 times, for instance, with even higher factors
for some of the binary datasets.
