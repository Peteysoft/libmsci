...
symbol & definition & first used \\ \hline
	...
	$\condprob(\class|\point)$ & conditional probability & S \ref{theory}\\
	$\jointprob(\class,\,\point)$ & joint probability & S \ref{theory} \\
	...
	$\probability(\point)$ & true probability density & (\ref{setting_the_bandwidth})\\
	...
	$\vec \svmcoeff=\lbrace \svmcoeff_i \rbrace$ & coefficients in weighted kernel estimator & (\ref{weighted_kernel_estimator})\\
	...
	$\vbdecision$ & variable kernel estimator for $\diffcondprob$ & (\ref{vb_kernel_r}) \\
...
symbol & definition & first used \\ \hline
	...
	$\rbkernelparam=\frac{1}{2\bandwidth^2}$ & parameter used for Gaussian kernels in SVM & S \ref{results_section} \\
