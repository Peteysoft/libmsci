...
symbol & definition & first used \\ \hline
	...
	$\testpoint$ & test point & (\ref{kernel_estimator})\\
	...
	$\svmbordervector$ & hyperplane normal of decision boundary in SVM & (\ref{decision_function0})\\
	$\svmborderconst$ & constant value defining location of decision boundary in SVM & (\ref{decision_function0})\\
