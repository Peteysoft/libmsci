...
\newcommand{\borderdecision}{\decision_{border}}
...
%scaling law:
\newcommand{\featurevolume}{V}	%volume of feature space
\newcommand{\mintrain}{n_0}	%minimum amount of training data
\newcommand{\minborders}{n_{b0}}	%minimum number of border samples

%svm kernels:
\newcommand{\rbkernelparam}{\gamma}

%sub-sampling: fraction of data split off from main body
\newcommand{\datafraction}{f}
