...
\section{INSTALLATION}
  ...
  A configure script is not supplied: please refer to the Peteysoft coding standards \verb\peteysoft_standards.txt\ in the base of the installation directory (\url{https://github.com/peteysoft/libmsci/blob/master/coding_standards.txt}).
...
we get the following list of statements as output in \verb"script.sh":
...
and the contents of \verb"foobar.txt" are as follows:
...
The \verb/%g/ can be changed to, e.g. \verb/%.12lg/ or a similar level of high precision.
