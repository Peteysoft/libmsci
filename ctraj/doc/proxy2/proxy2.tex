...
\begin{figure}
  \begin{tabular}{cccc}
    ...
    \includegraphics[width=0.25\textwidth]{svr4} &
    \includegraphics[width=0.25\textwidth]{svr3} &
    \includegraphics[width=0.25\textwidth]{svr2} &
    \includegraphics[width=0.25\textwidth]{svr1} \\
    b. Left SV 1 & d. Left SV 2 & f. Left SV 3 & h. Left SV 4 \\
    \includegraphics[width=0.25\textwidth]{svl4} &
    \includegraphics[width=0.25\textwidth]{svl3} &
    \includegraphics[width=0.25\textwidth]{svl2} &
    \includegraphics[width=0.25\textwidth]{svl1}
  \end{tabular}
  \label{sample_SV}
...
\begin{figure}
\includegraphics[width=0.45\textwidth]{passive1997.12.01.ps}
\includegraphics[width=0.45\textwidth]{firstpc1997.12.01.ps}
