...
\begin{figure}
    ...
    Highlighted points are for the first time grid (two days worth of data) between Sept. 25, 1998 and Sept 27, 1998.}
    \label{POAM_loc}
\end{figure}
...
the PC proxy.
Figures \ref{Nhemi}c. and \ref{Nhemi}d. shows results for interpolates for which the
...
Results for the Southern hemisphere, shown in Figure \ref{Shemi}, are even more 
