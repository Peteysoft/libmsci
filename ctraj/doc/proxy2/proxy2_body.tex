...
To generate the transport maps, the \textit{ctraj} software package is used (http://ctraj.sf.net) \citep{Mills2009}.  
...
For this case study, the PC proxy method definitely has the edge. On the other
