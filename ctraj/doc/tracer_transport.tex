...
%This derivation is false, but we leave this here as the two quantities
%are definitely related, but not so simply:
%We can relate $H$ to the integrated trajectory, $\Phi$, as follows:
%\begin{eqnarray}
%\frac{\mathrm d \Phi}{\mathrm d t} & = & v(\Phi, ~t) \\
%gradient operator and total derivative don't commute:
